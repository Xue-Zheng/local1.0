...
export default function ConfirmNorthernAttendance() {
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-8 mb-8 border-l-4 border-blue-500">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <strong className="text-gray-900">⏱️ Time span:</strong>
                                <p className="text-gray-700">[Insert Time, e.g. 2:00 PM – 4:00 PM, with a start time of ]</p>
                            </div>
                        ...
                        <div className="mt-6 p-4 rounded-lg bg-blue-50 border border-blue-200">
                            <p className="text-sm text-blue-800">
                                These meetings are official paid union meetings under Section 26 of the Employment Relations Act 2000, and your attendance is fully supported by E tū.
                            </p>
                    ...
                    <div className="text-center">
                        <button
                            ...
                            disabled={confirming}
                            className="inline-flex items-center px-8 py-4 text-lg font-semibold rounded-lg shadow-lg transform transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed bg-blue-600 hover:bg-blue-700 text-white"
                        >
                            {confirming ? (
                                <>
                    ...
                    <div className="text-center mt-8 text-gray-600">
                        ...
                        <p className="text-sm">
                            If you have any questions about your meeting details or need support, contact us:
                        </p>
