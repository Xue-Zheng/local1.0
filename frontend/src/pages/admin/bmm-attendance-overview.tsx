                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    {stats && (
                        <div className="mb-6">
                            ...
                            {/* Venue Distribution */}
                            {stats.venueDistribution && Object.keys(stats.venueDistribution).length > 0 && (
                                <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                                    <h2 className="text-xl font-bold text-gray-900 mb-4">🏢 Venue Distribution</h2>
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        {Object.entries(stats.venueDistribution)
                                            .sort(([,a], [,b]) => b - a)
                                            .map(([venue, count]) => (
                                                <div key={venue} className="bg-gray-50 rounded-lg p-4">
                                                    <p className="text-sm text-gray-600 font-medium truncate">{venue}</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    {stats && Object.keys(stats.venueDistribution).map(venue => (
                                        ...
                                        <tr key={conf.id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div>
                                                    ...
                                                    {conf.forumDesc && (
                                                        <div className="text-xs text-gray-500 mt-1">{conf.forumDesc}</div>
                                                    )}
                                                </div>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                {conf.isAttending ? (
                                                    <span className="px-2 py-1 bg-green-100 text-green-800 text-xs rounded">✅ Attending</span>
                                                ) : (
                                                    <span className="px-2 py-1 bg-red-100 text-red-800 text-xs rounded">❌ Not Attending</span>
                                                )}
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td className="px-6 py-4">
                                                {conf.isAttending && (
                                                    <div>
                                                        <div className="text-sm text-gray-900 truncate max-w-xs" title={conf.assignedVenue}>
                                                            {conf.assignedVenue || 'No venue assigned'}
                                                        </div>
                                                        {conf.assignedSession && (
                                                            <div className="text-xs text-gray-500">{conf.assignedSession}</div>
                                                        )}
                                                    </div>
                                                )}
                                            </td>
